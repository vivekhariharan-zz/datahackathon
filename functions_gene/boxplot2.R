# New Boxplot function with swanky background and gridlines
# Created during Phoenix project
# 20100929
# Author: gene.leynes
###############################################################################

boxplot2=function(x, y, fgcol='plum3', bgcol="lightyellow", addgridlines=TRUE, ...){
	#browser()
