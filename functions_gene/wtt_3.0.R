# 8/10/09
# 9/9/09 Version 2.0
# 11/22/09 added debug feature
# 12/21/09 adding autodetect desktop directory feature
# 05/25/10 adding data.frame conversion
# 12/02/10 added section to try and open the file instead of just writing it
#		   This addition depends on PBSmodelling package
# changing file to .csv for easier Excel access
# new temp.txt writin' file
# Author: gene.leynes
###############################################################################
